...
const ButtonSpec = createNamedTuple("ButtonSpec", [
  "name",
  "channel",
  "byte",
  "bit",
]);
const DeviceSpec = createNamedTuple("DeviceSpec", [
  "name",
  "hidIds",
  "ledId",
  "mappings",
...
export const DEVICE_SPECS = {
  SpaceNavigator: new DeviceSpec(
    ...
    [new ButtonSpec("LEFT", 3, 0, 0), new ButtonSpec("RIGHT", 3, 0, 1)],
    350.0,
  ),
  "SpaceMouse Compact": new DeviceSpec(
    ...
    [new ButtonSpec("LEFT", 3, 1, 0), new ButtonSpec("RIGHT", 3, 1, 1)],
    350.0,
  ),
